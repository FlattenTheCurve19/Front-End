      ...
      <ChartWrapper>
        <DataChart>
          ...
          <Typography variant="body2">
            There are a total of {total.Confirmed} cases in the U.S.
          </Typography>
          ...
          <Typography variant="body2">
            There are a total of {total.Recovered} cases that are confirmed in
            the U.S.
          </Typography>
          <ChartButton>Learn More</ChartButton>
          <br />
          ...
          <Typography variant="body2">
            At this time, there are {total.Deaths} deaths in the U.S.
          </Typography>
          <ChartButton>Learn More</ChartButton>
        </DataChart>
        {data ? (
